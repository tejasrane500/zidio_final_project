...
const CommentCard = ({ index, leftval, commentData }) => {
    ...
    const removeCommentsCard = (startingPoint, isDelete = false) => {
        ...
        setblog({ ...blog, commets: { results: commentsArr }, activity: { ...activity, total_parent_comments: total_parent_comments - (commentData.childrenLevel == 0 && isDelete ? 1 : 0) } })
    }
    ...
    const LoadMoreRepliesButton = () => {
        ...
        let button = <button onClick={() => loadReplies({ skip: index - parentIndex, currentIndex: parentIndex })} className="text-dark-grey p-2 px-2 hover:bg-grey/30 rounded-md flex items-center gap-2">Load More Replies</button>;
            ...
            <div className="my-5 p-6 rounded-md border border-grey">
                ...
                <div className="flex gap-5 items-center mt-5">
...

                    {
                        ...
                        <button className="p-2 px-3 rounded-md border border-grey ml-auto hover:bg-red/30 hover:text-red flex items-center" onClick={deleteCommentFun}>
