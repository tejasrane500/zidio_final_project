...
const NotificationCard = ({ data, index, notificationState }) => {
    ...
    let notification = notificationState?.notification || {};
    let notifications = notificationState?.notifications || {};
    let { results = [], totalDocs = 0 } = notifications;
    let setNotification = notificationState?.setNotification;
    
    const handleReplyClick = () => {

        setReplying(perVal => !perVal)
    ...
    const handleDelete = (comment_id, type, target) => {
        ...
        .then(() => {
            ...
            setNotification({ ...notification, results, totalDocs: totalDocs - 1, deletedDocCount: notification.deletedDocCount + 1 })
