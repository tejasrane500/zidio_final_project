...
const CommentsContainer = () => {
    ...
    const loadMoreComment = async () => {
        ...
        let newCommentArr = await fetchComments({ skip: totalParentCommentsLoaded, blog_id: blog._id, setParentCommentCountFun: setTotalParentCommentsLoaded, comment_array: commentsArr })
