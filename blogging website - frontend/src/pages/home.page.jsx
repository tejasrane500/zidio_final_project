            ...
            <section className="h-cover flex justify-center gap-10">
                ...
                <div className="min-w-[40%] lg:min-w-[400px] max-w-min border-l border-grey pl-8 pt-5 max-md:hidden">
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <h1 className="font-medium text-xl mb-8">Stories form all intrest</h1>
                    ...
                    <div>
                        ...
                        <h1 className="font-medium text-xl mb-8">Trending <i className="fi fi-sr-arrow-trend-up"></i></h1>
