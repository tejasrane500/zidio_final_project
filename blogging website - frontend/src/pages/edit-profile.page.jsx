...
const EditProfile = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if(username.length < 3){
            return toast.error("Username shoud be at least 3 letters long")
        }
                ...
                <form ref={editProfileForm}>
                    ...
                    <div className="flex flex-col  lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        ...
                        <div className="max-lg:center mb-5">
                            <label htmlFor="uploadImg" id="ProfileImgLable" className="relative block w-40 h-40 bg-grey rounded-full overflow-hidden">
                            ...
                            <button className="btn-light mt-5 max-lg:w-full px-10" onClick={handleImageUpload}>Upload</button>
                        </div>
                        ...
                        <div className="w-full">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5">
                                <div>
                                    <InputBox name="fullname" type="text" value={fullname} placeholder="FullName" disable={true} icon="fi fi-rr-user" />
                                </div>

                                <div>
                                    <InputBox name="email" type="email" value={email} placeholder="Email" disable={true} icon="fi fi-rr-envelope" />
                                </div>
                            </div>
                            ...
                            <textarea name="bio" maxLength={bioLimit} defaultValue={bio} className="input-box h-24 lg:h-40 resize-none leading-7 mt-5 pl-5" placeholder="Bio" onChange={handleCharacterChange}></textarea>
